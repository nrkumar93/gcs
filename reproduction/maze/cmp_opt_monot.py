...
# full_path = [1, 51, 52, 2, 3, 4, 54, 104, 154, 204, 203, 202, 252, 302, 301, 351, 401, 451, 501, 551, 552, 553, 554, 504, 505, 506, 556, 557, 507, 457]
...
for i, ctrs in enumerate(region_centers):
    ...
    plt.scatter(ctrs[0], ctrs[1], s=500, marker='s', alpha=0.3, c='red', edgecolors='green')
    plt.text(ctrs[0], ctrs[1], full_path[i], fontsize=12, ha='center', va='center')
